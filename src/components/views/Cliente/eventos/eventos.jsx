...
class Eventos extends Component{
    ...
    // Esta funcion se encarga de capturar lo que el usuario escriba
    onChange=async e=>{
        e.persist();
                            ...
                            <div className="row text-center align-items-center border " >
                                ...
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="dropdown-item">
                                        <a href={"/DetallesECliente/"+evento.id_evento} className="btn btn-dark">Detalles</a>
                                    </li>
                                </ul>
                                </div>
                            </div>
